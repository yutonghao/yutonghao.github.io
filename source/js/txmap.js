...
$.ajax({
    ...
    data: {
        key: '7CABZ-QL5LL-YG4PX-MTFMZ-VU6BK-IZBN6',
        output: 'jsonp',
    },
    dataType: 'jsonp',
...
function showWelcome() {
    ...
    let dist = getDistance(113.58762, 22.53332, ipLoacation.result.location.lng, ipLoacation.result.location.lat); //这里换成自己的经纬度
